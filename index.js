...
function customEntries(obj) {
  ...
  const returnedTarget = Object.entries(obj);
  return returnedTarget;
}
...
function customObjectFromEntries(entries) {
  ...
  const entriesFrom = Object.fromEntries(processedEntries);
  return entriesFrom;
...
function checkProperty(obj, prop) {
  ...
  const checkObj = obj.hasOwnProperty(prop);
  return checkObj;
}
...
function extendAndFreezeObject(obj1, obj2) {
  ...
  const obgFreeze = Object.freeze(returnedTarget);
  return obgFreeze;
...
function checkAndPreventExtensions(obj) {
  ...
  const objPrevenr = Object.preventExtensions(obj);
  const objIs = Object.isExtensible(objPrevenr);
  return objIs;
...
function sealAndCheck(obj) {
  ...
  const objIs = Object.isSealed(objSeal);
  return objIs;
...
function checkOwnership(obj1, obj2, key) {
  ...
  const checkOwn = obj1.hasOwnProperty(key);
  const checkTwo = obj2.hasOwnProperty(key);
  let result = checkOwn === checkTwo;
  return result;
...
function getObjectValuesSum(obj) {
  ...
  const objValue = Object.values(obj);
  const sum = objValue.reduce((total, product) => {
